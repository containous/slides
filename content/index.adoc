...
image:crd.png[width=120]
[.crd.text]
Kubernetes CRD

image:opentracing-logo.png[width=120]

image:prometheus.png[width=120]

image:grafana.jpg[width=120]
...
image::traefikee-architecture-gray-bg.png[]
...
* Distributed middletier management
* High Availabity by default
