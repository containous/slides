...
* link:https://traefik.io/[Traefik] maintainers
* link:https://twitter.com/michaelmatur[+++<span class="fab fa-twitter"></span>+++ @michaelmatur,window="_blank"]
* link:https://github.com/mmatur[+++<span class="fab fa-github"></span>+++ mmatur,window="_blank"]

image::michael-bw.jpg[height=200]
