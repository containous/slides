...
link:https://events.docker.com/events/details/docker-san-francisco-presents-traefik-v20-in-docker-containerd-updates/#/[San Francisco Docker Meetup - Tuesday 24th of September 2019]
