...
----
include::../../demo/traefik-v1/software-forge/docker-compose.yml[tag=jenkins-labels-port]
----
...
[source,yaml,indent=0]
----
include::../../demo/traefik-v1/software-forge/docker-compose.yml[tag=jenkins-labels-rule]
----
...
[source,yaml,indent=0]
----
include::../../demo/traefik-v1/software-forge/docker-compose.yml[tag=jenkins-env-opts]
----
...
[source,yaml,indent=0]
----
include::../../demo/traefik-v1/software-forge/docker-compose.yml[tag=jenkins]
----
