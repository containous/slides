...
**Solution:** Define a service linked to an external address in `lab2-web.yml`.
...
**Solution:** Define a rule to catch all the incoming resquests for the `PathPrefix:/` in `lab2-web.yml`.
