...
* **Problem:** How to tell to Traefik to route requests to the web server which is not deloyed in Kubernetes?
...
* **Solution:**  Catch all the incoming resquests for the `Path: /`:
