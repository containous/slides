...
+
* **Solution:** Configure the new link:https://docs.traefik.io/basics/#entrypoints[entrypoint] `http`.
+
[source,toml,indent=0]
----
...
* **Solution:** 
+
** Step 1: Configure the link:https://docs.traefik.io/configuration/acme/[ACME/Let's Encrypt provider]:
...
** Step 2: Give the needed rights to the `acme.json` file:
