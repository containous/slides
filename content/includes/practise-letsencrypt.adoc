...
----
include::../../demo/v1/docker-compose-ssl.yml[tag=traefik-entrypoints-https]
----
...
[source,yaml,indent=0]
----
include::../../demo/v1/docker-compose-ssl.yml[tag=traefik-entrypoints-http]
----
...
[source,yaml,indent=0]
----
include::../../demo/v1/docker-compose-ssl.yml[tag=traefik-entrypoints-acme]
----
...
[source,yaml]
----
include::../../demo/v1/docker-compose-ssl.yml[tag=traefik-ssl]
----
