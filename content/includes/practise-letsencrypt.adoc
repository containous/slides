...
http://traefik-demo.containous.cloud/
  -> https://traefik-demo.containous.cloud/
```
...
----
include::../../demo/docker-compose-ssl.yml[tag=traefik-entrypoints-https]
----
...
[source,yaml,indent=0]
----
include::../../demo/docker-compose-ssl.yml[tag=traefik-entrypoints-http]
----
...
[source,yaml,indent=0]
----
include::../../demo/docker-compose-ssl.yml[tag=traefik-entrypoints-acme]
----
...
* **Problem:** 
** Traefik detects itself as a docker container with a port, and tries to request a 2nd certificate for `edge.traefik-demo.containous.cloud`
...
[source,yaml]
----
include::../../demo/docker-compose-ssl.yml[tag=traefik-ssl]
----
...
// [.shadow]
// image::after-ssl-up.png[width=500]
